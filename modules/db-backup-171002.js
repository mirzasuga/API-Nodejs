    ...
    var functions = {
	    ...
	    getCurrentCampaign(params,cb){
            ...
            callSpUpdateProfile:function(params,cb){
                var query = 'call stickearn_v2.api_update_driver_profile(:driver_id,:name,:email,:mobile_number,:account_number,:reg_number,:img_vehicle,:img_stnk,:img_sim,:img_tabungan)';
                statement(query,params,cb);
            },
